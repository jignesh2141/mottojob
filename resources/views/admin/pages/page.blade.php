                    ...
                    <div class="card">
                      ...
                      <div class="card-body card-block">
                          ...
                          <div class="row form-group">
                            ...
                            <div class="col-12 col-md-5"><textarea name="en_description" id="en_description" rows="9" placeholder="EN Content..." class="form-control"></textarea></div>
                            <div class="col-12 col-md-5"><textarea name="ja_description" id="ja_description" rows="9" placeholder="JA Content..." class="form-control"></textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Meta Keywords</label></div>
                            <div class="col-12 col-md-5"><textarea name="en_meta_keywords" id="en_meta_keywords" rows="9" placeholder="EN Content..." class="form-control"></textarea></div>
                            <div class="col-12 col-md-5"><textarea name="ja_meta_keywords" id="ja_meta_keywords" rows="9" placeholder="JA Content..." class="form-control"></textarea></div>
                          </div>
                          <div class="row form-group">
                            <div class="col col-md-2"><label for="text-input" class=" form-control-label">Meta Description</label></div>
                            <div class="col-12 col-md-5"><textarea name="en_meta_description" id="en_meta_description" rows="9" placeholder="EN Content..." class="form-control"></textarea></div>
                            <div class="col-12 col-md-5"><textarea name="ja_meta_description" id="ja_meta_description" rows="9" placeholder="JA Content..." class="form-control"></textarea></div>
                          </div>
                      </div>
