            ...
            <div class="row">
                ...
                <div class="form-section">
                    ...
                    <div class="col-md-12 col-sm-12 no-padding">
                        <p class="privacy">{{ trans('job.by_applying') }} <a href="{{ url('/page/terms-of-service') }}">{{ trans('general.terms') }}</a> {{ trans('job.and') }} <a href="{{ url('/page/privacy-policy') }}">{{ trans('general.privacy') }}</a></p>
                    </div>
                </div>
